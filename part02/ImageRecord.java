...
public class ImageRecord {
    ...
    public ImageRecord(String title, String description, ImageType other, LocalDate date, String thumbnail) {// method to initialise an image record including the image details.
